# Generated by Django 3.1.3 on 2022-07-03 14:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_status', models.CharField(choices=[('Correct', 'Correct'), ('Incorrect', 'Incorrect'), ('Unscored', 'Unscored')], default='Incorrect', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty_level', models.CharField(choices=[('Hard', 'Hard'), ('Medium', 'Medium'), ('Easy', 'Easy')], default='Medium', max_length=20)),
                ('associated_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_course', to='onlinecourse.course')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_choice', to='onlinecourse.question'),
        ),
    ]
